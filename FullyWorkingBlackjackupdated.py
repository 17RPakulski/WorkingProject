...
Objectives
basic:
    1. show that the game is able to play till completion and that each game is random
    2. show each input (gamemode, email, hitstand) and how every input is validated
    3. show that each of the gamemodes are functioning: singleplayer, multiplayer and simulation
advanced:
    1. show that the data is stored ina csv file and analysis is
       made in the form of a bar chart
    2. show the percentage of wins represented by a bar chart
    3. my program is able analyise two different
       strategies
